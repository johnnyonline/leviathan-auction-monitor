# leviathan-auction-monitor

[**Join on Telegram**](https://t.me/+zLSWSgGt3OJlMjE0)

## Installation

1. **Clone the repository**
   ```bash
   git clone https://github.com/johnnyonline/leviathan-auction-monitor.git
   cd leviathan-auction-monitor
   ```
